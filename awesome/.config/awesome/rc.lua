...
-- MuhWidgets
local muhwidgets = require("muhwidgets")
-- local muhsettings = muhwidgets.muhsettings
-- }}}
...
mytextclock:connect_signal("mouse::leave", function()
    mytextclock:set_markup(markup(beautiful.fg_normal,
        mytextclock.text))
end)

mytextclock_tf = awful.tooltip({
    objects = { mytextclock },
...
--    s.mypromptbox.set_shape(gears.shape.hexagon, 70, 20)
    ...
    s.mysystray.forced_width=205
    s.mysystray.forced_height=24
...
--            mybattery.widget,
        ...
        ,left=8,right=12,top=0,bottom=0
    }
...
globalkeys = awful.util.table.join(
    ...
    -- Client's titlebar manipulation
    awful.key({modkey, "c"}, "t", function () awful.titlebar.toggle(client.focus) end,
              {description = "toggle focused client's titlebar", group = "client"}),
...
--    { rule = { name = "urxvt" },
--      properties = { shape = gears.shape.rounded_bar }
--    },
...
client.connect_signal("request::titlebars", function(c)
    ...
    awful.titlebar(c, {size=29}) : setup {
        { -- Left
